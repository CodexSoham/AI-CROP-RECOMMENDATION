        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-stone-900 dark:text-white tracking-tight leading-tight">
              Frequently asked{' '}
              <span className="font-serif italic font-normal text-4xl sm:text-5xl text-[#46B847] dark:text-[#7ED937]">
                questions
              </span>
            </h2>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="w-7 h-7 rounded-full bg-stone-100 dark:bg-stone-800 flex items-center justify-center shrink-0 text-stone-600 dark:text-stone-300">
            ...
            <div className="lg:col-span-4 flex flex-col justify-between">
              <div>
                ...
                <div className="mt-6 text-xs text-stone-400 space-y-1">
                  <div>Albany, NY 12208, USA</div>
                  <div>+1 (518) 555-0147</div>
                  <div className="text-[#6FD73B] hover:underline cursor-pointer">
          ...
          <div className="py-10 flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-6">
              ...
              <span className="text-4xl sm:text-7xl lg:text-8xl font-black tracking-tighter text-white select-none">
                Kshetra<span className="text-[#6FD73B]">AI</span>
              </span>
            </div>
          </div>
