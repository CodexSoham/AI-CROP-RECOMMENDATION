...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-900 dark:bg-[#071610] text-slate-400 py-12 border-t border-slate-800 dark:border-emerald-950/80 text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-4 flex items-center gap-3 text-[11px] text-emerald-400">
        ...
        <div className="pt-8 border-t border-slate-800 dark:border-emerald-950/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500">
          <div>
