...
export const TechShowcase: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-slate-50 dark:bg-[#0c2018] border-t border-slate-200/80 dark:border-emerald-950/60 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="p-6 rounded-3xl bg-white dark:bg-[#112A20] border border-slate-200/80 dark:border-emerald-800/50 shadow-md flex flex-col justify-between relative"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-slate-100 dark:bg-emerald-950 text-slate-600 dark:text-emerald-300">
                    {step.badge}
                  </span>
                </div>
              ...
              <div className="pt-3 border-t border-slate-100 dark:border-emerald-900/40 text-[11px] font-semibold text-emerald-700 dark:text-emerald-300 flex items-center gap-1.5">
