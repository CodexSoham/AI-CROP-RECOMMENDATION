...
export const FeaturesGrid: React.FC = () => {
  ...
  return (
    <section className="py-16 lg:py-24 bg-white dark:bg-[#112A20] transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feature, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-8 rounded-3xl bg-slate-50 dark:bg-emerald-950/30 border border-slate-200/80 dark:border-emerald-800/50 hover:border-emerald-500/50 transition-all hover:shadow-xl group relative overflow-hidden"
              >
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-2xl bg-emerald-100 dark:bg-emerald-900/60 text-emerald-700 dark:text-emerald-300 flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
                ...
                <div className="pt-4 border-t border-slate-200/70 dark:border-emerald-900/50 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
