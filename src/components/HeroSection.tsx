...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative overflow-hidden pt-12 pb-16 lg:pt-16 lg:pb-24 border-b border-slate-200/80 dark:border-emerald-950/60">
      {/* Subtle organic background mesh */}
      <div className="absolute inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute -top-36 -left-36 w-96 h-96 rounded-full bg-emerald-500/10 dark:bg-emerald-500/5 blur-3xl"></div>
        <div className="absolute top-1/2 -right-36 w-96 h-96 rounded-full bg-teal-500/10 dark:bg-emerald-400/5 blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            {/* Pill Tag */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-100/80 dark:bg-emerald-950/90 border border-emerald-300/60 dark:border-emerald-700/60 text-emerald-800 dark:text-emerald-300 text-xs font-semibold mb-6 shadow-sm">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3.5 w-full sm:w-auto">
              <button
                ...
                className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white font-bold text-sm sm:text-base shadow-lg shadow-emerald-600/25 hover:shadow-emerald-600/35 transition-all flex items-center justify-center gap-2.5 group"
              >
              ...
              <button
                onClick={onOpenOcr}
                className="w-full sm:w-auto px-5 py-3.5 rounded-2xl bg-white hover:bg-slate-50 dark:bg-emerald-950/60 dark:hover:bg-emerald-900/60 text-slate-800 dark:text-emerald-200 font-semibold text-sm sm:text-base border border-slate-300 dark:border-emerald-800/60 shadow-sm transition-colors flex items-center justify-center gap-2"
              >
            ...
            {/* Trust Markers */}
            <div className="mt-10 grid grid-cols-3 gap-6 pt-6 border-t border-slate-200/80 dark:border-emerald-950/60 w-full max-w-xl text-left">
              <div>
              ...
              <div>
                <div className="text-xl sm:text-2xl font-black text-emerald-600 dark:text-emerald-400">100% XAI</div>
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="p-6 rounded-3xl bg-white dark:bg-[#112A20] border border-slate-200 dark:border-emerald-800/60 shadow-2xl relative z-10">
                ...
                <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-emerald-900/50">
                  ...
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 text-[10px] font-bold bg-emerald-100 dark:bg-emerald-900/80 text-emerald-800 dark:text-emerald-300 rounded-full">
                ...
                <div className="p-4 rounded-2xl bg-gradient-to-br from-emerald-600 to-emerald-800 text-white shadow-lg relative overflow-hidden">
                ...
                <button
                  onClick={onLaunchEngine}
                  className="mt-4 w-full py-2 text-center text-xs font-bold text-emerald-700 dark:text-emerald-300 hover:text-emerald-800 flex items-center justify-center gap-1 group"
                >
              ...
              <div className="absolute -bottom-5 -left-5 p-3 rounded-2xl bg-white dark:bg-[#1E3A2B] border border-slate-200 dark:border-emerald-700 shadow-xl hidden sm:flex items-center gap-2.5 z-20">
              ...
              <div className="absolute -top-4 -right-4 p-3 rounded-2xl bg-white dark:bg-[#1E3A2B] border border-slate-200 dark:border-emerald-700 shadow-xl hidden sm:flex items-center gap-2.5 z-20">
